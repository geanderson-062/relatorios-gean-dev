...
$pdf->Image('../api/img/favicon/android-icon-72x72.png');
...
$pdf->Cell(140,10,('Relatorio de Sistemas'),0,0,"C");//titulo
...
$pdf->Cell(30, 7, 'N publicado' ,1,0,'c');
